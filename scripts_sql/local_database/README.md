...
:warning: Si le jeu de données que vous souhaitez importer est de grande taille (càd, plus de 20 000 entrées), prévoyez d'avoir suffisament d'espace disque disponible (càd au moins 100 Go) pour permettre à PostgreSQL d'écrire les données temporaires nécessaires.
