-- Ajout des données extraites par mots-clés dans la table locale directories_graph.directories_content
...
-- Ajout des données extraites par mots-clés dans la table locale directories_graph.geocoding
